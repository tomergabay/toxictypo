...
docker pull public.ecr.aws/c7o8u9c1/toxicapp:${env.BUILD_NUMBER}
docker run --name application -p 8080:8080 public.ecr.aws/c7o8u9c1/toxicapp:${env.BUILD_NUMBER}
EOF
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~deplyed~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
